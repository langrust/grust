        ...
        impl SpeedLimiterService {
            ...
            pub async fn handle_vdc(
                ...
                if self.delayed {
                    ...
                    if let Some(in_regulation) = *in_regulation_ref {
                        self.send_output(O::InRegulation(in_regulation, _vdc_instant))
                            .await?;
                    }
                } else {
            ...
            pub async fn handle_vacuum_brake(
                ...
                if self.delayed {
                    ...
                    if let Some(in_regulation) = *in_regulation_ref {
                        self.send_output(O::InRegulation(in_regulation, _vacuum_brake_instant))
                            .await?;
                    }
                } else {
                    let unique = self
            ...
            pub async fn handle_set_speed(
                ...
                if self.delayed {
                    ...
                    if let Some(in_regulation) = *in_regulation_ref {
                        self.send_output(O::InRegulation(in_regulation, _set_speed_instant))
                            .await?;
                    }
                } else {
                    let unique = self
            ...
            pub async fn handle_delay_speed_limiter(
                ...
                if self.input_store.not_empty() {
                    ...
                    match (
                        ...
                        (Some((vdc, _vdc_instant)), None, None, None, None, None, None, None) => {
                            let in_regulation_ref = &mut None;
                            self.context.vdc.set(vdc);
                            if self.context.vacuum_brake.is_new()
                                || self.context.vdc.is_new()
            ...
            pub async fn handle_speed(
                ...
                if self.delayed {
                    ...
                    if let Some(in_regulation) = *in_regulation_ref {
                        self.send_output(O::InRegulation(in_regulation, _speed_instant))
                            .await?;
                    }
                } else {
