...
impl ProcessSetSpeedState {
    ...
    pub fn step(&mut self, input: ProcessSetSpeedInput) -> (f64, bool) {
        ...
        let (v_update, v_set) = match (input.set_speed) {
            (Some(v)) => {
...
impl SpeedLimiterOnState {
    ...
    pub fn step(&mut self, input: SpeedLimiterOnInput) -> (SpeedLimiterOn, bool, bool) {
        ...
        let (hysterisis, on_state, state_update) = match (input.kickdown) {
            ...
            (_) => {
                let (hysterisis, on_state, state_update) = match input.prev_on_state {
...
impl SpeedLimiterState {
    ...
    pub fn step(&mut self, input: SpeedLimiterInput) -> (SpeedLimiter, SpeedLimiterOn, bool, bool) {
        ...
        let (state_update, in_regulation, on_state, state) =
            match (input.activation_req, input.failure) {
                ...
                (_, _) => {
                    let (state_update, in_regulation, on_state, state) = match prev_state {
                        SpeedLimiter::On => {
    ...
    pub mod speed_limiter_service {
        ...
        impl Context {
            ...
            fn get_speed_limiter_inputs(
                ...
                SpeedLimiterInput {
                    vacuum_brake_state: self.vacuum_brake.get(),
                    vdc_disabled: self.vdc.get(),
        ...
        impl SpeedLimiterService {
            ...
            pub async fn handle_activation(
                ...
                if self.delayed {
                    ...
                    let on_state = self.context.on_state.get();
                    let sl_state = on_state;
                    self.send_output(O::SlState(sl_state, activation_instant))
                        .await?;
                    let in_regulation_aux = self.context.in_regulation_aux.get();
                    let in_regulation = in_regulation_aux;
                    self.send_output(O::InRegulation(in_regulation, activation_instant))
                        .await?;
                } else {
                    let unique = self
                        .input_store
            ...
            pub async fn handle_failure(
                ...
                if self.delayed {
                    ...
                    let in_regulation_aux = self.context.in_regulation_aux.get();
                    let in_regulation = in_regulation_aux;
                    self.send_output(O::InRegulation(in_regulation, failure_instant))
                        .await?;
                } else {
            ...
            pub async fn handle_timeout_speed_limiter(
                ...
                let v_set_aux = self.context.v_set_aux.get();
                let v_set = v_set_aux;
            ...
            pub async fn handle_kickdown(
                ...
                if self.delayed {
                    ...
                    let in_regulation_aux = self.context.in_regulation_aux.get();
                    let in_regulation = in_regulation_aux;
                    self.send_output(O::InRegulation(in_regulation, kickdown_instant))
                        .await?;
                } else {
                    let unique = self
                        .input_store
            ...
            pub async fn handle_set_speed(
                ...
                if self.delayed {
                    ...
                    let x = self.context.x.get();
                    if self.context.changed_set_speed_old.get() != x {
                        self.context.changed_set_speed_old.set(x);
            ...
            pub async fn handle_delay_speed_limiter(
                ...
                if self.input_store.not_empty() {
                    ...
                    match (
                        ...
                        (None, None, None, None, None, None, Some((vdc, vdc_instant)), None) => {
                            self.context.vdc.set(vdc);
                        }
                        (
                            None,
