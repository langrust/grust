...
impl AccState {
    ...
    #[requires(input.c == > -10.0f64 <= d_dt && d_dt <= 0.0f64)]
    #[requires(input.c == > input.d >= input.v * 1.0f64 - input.v * d_dt /
    0.6f64 * 9.81f64)]
    #[ensures(input.c == > forall < _t : f64 > 0.0f64 < _t && _t <= - d_dt /
    result == > input.d + d_dt * _t + result * _t * _t / 2.0f64 >= d_s)]
