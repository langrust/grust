        ...
        impl ScanSampleService {
            ...
            pub async fn handle_period_sampled_pedestrian(
                ...
                if self.delayed {
                    ...
                    *sampled_pedestrian_ref = self.context.pedestrian.take();
                    ...
                    assert!(
                        unique.is_none(),
                        "flow `period_sampled_pedestrian` changes too frequently"
                    );
                }
                Ok(())
            }
            pub async fn handle_period_scanned_temperature(
                ...
                if self.delayed {
                    ...
                    assert!(
                        unique.is_none(),
                        "flow `period_scanned_temperature` changes too frequently"
                    );
                }
                Ok(())
            }
            pub async fn handle_temperature(
                ...
                if self.delayed {
                    ...
                    assert!(
                        unique.is_none(),
                        "flow `temperature` changes too frequently"
                    );
                }
                Ok(())
            }
            ...
            pub async fn handle_pedestrian(
                ...
                if self.delayed {
                    ...
                    *pedestrian_ref = Some(pedestrian);
                    ...
                    assert!(unique.is_none(), "flow `pedestrian` changes too frequently");
                }
                Ok(())
            }
            #[inline]
