...
fn rust_ast_from_lir_transformation_for_counter() {
    ...
    let counter_id = files.add(
        "counter.gr",
        std::fs::read_to_string("tests/fixture/rust_ast_from_lir/success/counter.gr")
            .expect("unkown file"),
    );
...
fn rust_ast_from_lir_transformation_for_blinking() {
    ...
    let blinking_id = files.add(
        "blinking.gr",
        std::fs::read_to_string("tests/fixture/rust_ast_from_lir/success/blinking.gr")
            .expect("unkown file"),
    );
...
fn rust_ast_from_lir_transformation_for_button_management() {
    ...
    let button_management_id = files.add(
        ...
        std::fs::read_to_string("tests/fixture/rust_ast_from_lir/success/button_management.gr")
            .expect("unkown file"),
    );
...
fn rust_ast_from_lir_transformation_for_button_management_condition_match() {
    ...
    let button_management_condition_match_id = files.add(
        ...
        std::fs::read_to_string(
            "tests/fixture/rust_ast_from_lir/success/button_management_condition_match.gr",
        )
        .expect("unkown file"),
    );
...
fn rust_ast_from_lir_transformation_for_button_management_using_function() {
    ...
    let button_management_using_function_id = files.add(
        ...
        std::fs::read_to_string(
            "tests/fixture/rust_ast_from_lir/success/button_management_using_function.gr",
        )
        .expect("unkown file"),
    );
...
fn rust_ast_from_lir_transformation_for_pid() {
    ...
    let pid_id = files.add(
        "pid.gr",
        std::fs::read_to_string("tests/fixture/rust_ast_from_lir/success/pid.gr")
            .expect("unkown file"),
    );
