...
impl Node {
    ...
    /// let mut errors = vec![];
    ///
    /// let node =Node { assertions: Default::default(), contract: Default::default(),
    ///     id: String::from("test"),
    ///     is_component: false,
    ///     inputs: vec![(String::from("i"), Type::Integer)],
    ///     equations: vec![
    ...
    /// };
    ///
    /// let control =Node { assertions: Default::default(), contract: Default::default(),
    ///     id: String::from("test"),
    ///     is_component: false,
    ///     inputs: vec![],
    ///     equations: vec![
    ...
    pub fn resolve_undefined_types(
        ...
        // resolve undefined equations types
        equations
            .iter_mut()
...
mod resolve_undefined_types {
    ...
    #[test]
    fn should_resolve_undefined_types_when_in_context() {
        let mut errors = vec![];
        let mut user_types_context = HashMap::new();
        user_types_context.insert(
            String::from("Point"),
