...
/// LanGRust [Function](crate::hir::function::Function) AST module.
pub mod function;

/// LanGRust [StreamExpression](crate::hir::stream_expression::StreamExpression) AST module.
pub mod stream_expression;

/// LanGRust [Expression](crate::hir::expression::Expression) AST module.
pub mod expression;

/// LanGRust [Equation](crate::hir::equation::Equation) AST module.
pub mod equation;

/// LanGRust [Statement](crate::hir::statement::Statement) AST module.
pub mod statement;
