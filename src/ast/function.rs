...
impl Function {
    ...
    ///         },
    ///     ],
    ///     returned: (Type::NotDefinedYet(String::from("Point")), Expression::Identifier {
    ///         id: String::from("o"),
    ///         typing: None,
    ///         location: Location::default(),
    ///     }),
    ...
    ///         },
    ///     ],
    ///     returned: (Type::Structure(String::from("Point")), Expression::Identifier {
    ///         id: String::from("o"),
    ///         typing: None,
    ///         location: Location::default(),
    ///     }),
    ...
    pub fn resolve_undefined_types(
        ...
        // resolve undefined inputs types
        inputs
            .iter_mut()
            .map(|(_, input_type)| {
        ...
        // resolve undefined statements types
        statements
            .iter_mut()
        ...
        // resolve undefined returned type
...
mod resolve_undefined_types {
    ...
    #[test]
    fn should_resolve_undefined_undefined_types_when_in_context() {
        let mut errors = vec![];
        let mut user_types_context = HashMap::new();
        user_types_context.insert(
            String::from("Point"),
